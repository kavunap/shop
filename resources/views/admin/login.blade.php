...
<html lang="en" class="light">
    ...
    <head>
        ...
        <meta name="description" content="Horebu Micro Insurance(HMI)">
        <meta name="keywords" content="Horebu, Micro Insurance in Rwanda, HMI, Insurance in Rwanda ">
        <meta name="author" content="horebu micro insurance HMI">
        <title>Login - Horebu - Micro Insurance</title>
        <!-- BEGIN: CSS Assets-->
            ...
            <div class="block xl:grid grid-cols-2 gap-4">
                ...
                <div class="hidden xl:flex flex-col min-h-screen">
                    <a href="/" class="-intro-x flex items-center pt-5">
                        <img alt="HMI" class="w-6" src="{{ asset('assets/images/logo.jpg') }}">
                        <span class="text-white text-lg ml-3"> Horebu<span class="font-medium">Insurance</span> </span>
                    </a>
                    <div class="my-auto">
                        <img alt="horebu micro insurance in rwanda" class="-intro-x w-1/2 -mt-16" src="dist/images/illustration.svg">
                    ...
                    <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                        <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-dark-1 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                            ...
                            <div class="intro-x mt-8">
                                <input type="email" class="intro-x login__input form-control py-3 px-4 border-gray-300 block" placeholder="Email" name="email">
