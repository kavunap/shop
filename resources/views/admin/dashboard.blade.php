...
<div class="grid grid-cols-12 gap-6">
                    ...
                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                        <div class="report-box zoom-in">
                            <div class="box p-5">
                                ...
                                <div class="text-3xl font-bold leading-8 mt-6">{{ App\Models\Visitor::distinct('ip')->count() }}</div>
                    ...
                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                        <div class="report-box zoom-in">
                            <div class="box p-5">
                                ...
                                <div class="text-3xl font-bold leading-8 mt-6">{{ App\Models\Visitor::all()->count() }}</div>
                                
                                <div class="text-base text-gray-600 mt-1">All Visitor</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-span-12 lg:col-span-6 mt-8">
                ...
                <div class="intro-y box p-5 mt-12 sm:mt-5">
                    <div class="flex flex-col xl:flex-row xl:items-center">
                        <div class="flex">
                            <div>
                                <div class="text-theme-24 dark:text-gray-300 text-lg xl:text-xl font-bold">$15,000</div>
                    ...
                    <div class="intro-y">
                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                            <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                <img alt="Shimuhahe Rwandan online shopping" src="dist/images/profile-2.jpg">
                            </div>
                    ...
                    <div class="intro-y">
                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                            ...
                            <div class="ml-4 mr-auto">
                                ...
                                <div class="text-gray-600 text-xs mt-0.5">23 January 2021</div>
                            </div>
                            <div class="py-1 px-2 rounded-full text-xs bg-theme-20 text-white cursor-pointer font-medium">137 Sales</div>
                        </div>
                    </div>
                    ...
                    <div class="intro-y">
                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                            ...
                            <div class="ml-4 mr-auto">
                                ...
                                <div class="text-gray-600 text-xs mt-0.5">14 August 2021</div>
                            </div>
                            <div class="py-1 px-2 rounded-full text-xs bg-theme-20 text-white cursor-pointer font-medium">137 Sales</div>
                        </div>
                    </div>
                                ...
                                <td class="w-40">
                                    <div class="flex">
                                        <div class="w-10 h-10 image-fit zoom-in">
                                            <img alt="{{ $product->name }}" class="tooltip rounded-full" src="/image/{{ $product->image }}" title="Uploaded at 2 April 2022">
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <a href="" class="font-medium whitespace-nowrap">{{ $product->name }}</a> 
                                    <div class="text-gray-600 text-xs whitespace-nowrap mt-0.5">{{ $product->description }}</div>
                                </td>
                                <td class="text-center">{{ $product->amount }}</td>
                                <td class="w-40">
                                    <div class="flex items-center justify-center text-theme-20"> <i data-feather="check-square" class="w-4 h-4 mr-2"></i> {{ $product->status }} </div>
                                </td>
    ...
    <div class="col-span-12 xxl:col-span-3">
        <div class="xxl:border-l border-theme-31 -mb-10 pb-10">
                    ...
                    <div class="mt-5">
                        <div class="intro-x">
                            <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                ...
                                <div class="text-theme-20">+$157</div>
                            </div>
                        </div>
                        <div class="intro-x">
                            <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                ...
                                <div class="text-theme-20">+$85</div>
                            </div>
                        </div>
                        <div class="intro-x">
                            <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                ...
                                <div class="text-theme-20">+$29</div>
                            </div>
                        </div>
                        <div class="intro-x">
                            <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                ...
                                <div class="text-theme-20">+$125</div>
                            </div>
                        </div>
                        <div class="intro-x">
                            <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                ...
                                <div class="ml-4 mr-auto">
                                    ...
                                    <div class="text-gray-600 text-xs mt-0.5">1 June 2022</div>
                                </div>
                                <div class="text-theme-21">-$41</div>
                            </div>
                        </div>
                    ...
                    <div class="report-timeline mt-5 relative">
                                ...
                                <div class="text-gray-600">
                                    ...
                                    <div class="flex mt-2">
                                        <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Oppo Find X2 Pro">
                                            <img alt="Tinker Tailwind HTML Admin Template" class="rounded-md border border-white" src="dist/images/preview-13.jpg">
                                        </div>
                        ...
                        <div class="intro-x relative flex items-center mb-3">
                            ...
                            <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                ...
                                <div class="text-gray-600 mt-1">Has changed <a class="text-theme-30 dark:text-theme-25" href="">Nike Air Max 270</a> price and description</div>
                            </div>
                        </div>
                        <div class="intro-x relative flex items-center mb-3">
                            <div class="report-timeline__image">
                            ...
                            <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                ...
                                <div class="text-gray-600 mt-1">Has changed <a class="text-theme-30 dark:text-theme-25" href="">Apple MacBook Pro 13</a> description</div>
                            </div>
                        </div>
                    </div>
                </div>
